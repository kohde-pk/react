...
import { C_API_URL, C_LOMM_DATA_URL, C_LOMM_CARD_STYLE_URL } from 'src/app/shared/constants/paths';
...
export class DataService {
  ...
  //   // get users from api
  //   return this.HttpClient.get('assets/ordersummary.json')//, options)
  ...
  getLommCardSummary(): ICardSummary {
    return {
      ...
      'Operating EBIDA': {
        ...
        'link1': { 'label': 'Operations Perforamnce Dashbaord (OPD)', 'link': 'http://rdcbiqlik08.chi.catholichealth.net/sense/app/313c281a-8959-461c-aec0-29f49fb3726c/sheet/bae1cecd-b388-4ba5-98ff-a9c6fe66fbb1/state/analysis' },
      ...
      'Growth': {
        ...
        'link1': { 'label': 'Market Share Explorer', 'link': 'http://rdcbiqlik08.chi.catholichealth.net/sense/app/956fe3a1-79e5-45df-938b-9f713c51d4c3/sheet/a33ff29f-34a8-4fd4-b5ff-5941f1a796e4/state/analysis' },
        'link2': { 'label': 'Observation Patients Explorer', 'link': 'http://rdcbiqlik08.chi.catholichealth.net/sense/app/8fe6c0e3-2225-4dc3-8eb0-e2ce09037d2f/sheet/7ace57f5-93ee-45fd-9c3a-813041006eaf/state/analysis' },
        'link3': '',
        'link4': '',
        'link5': '',
        'link6': ''
