...
import { C_QLIK_SERVER_PROTOCOL, C_QLIK_SERVER_DOMAIN, C_QLIK_SERVER_PORT } from '../constants/qlik_server_parameters';

export class QlikAPI {
    constructor() {}
    public static generateQlikAppURL =
        (configOptions: IQlikAppURLConfig, protocol: string = C_QLIK_SERVER_PROTOCOL, domain: string = C_QLIK_SERVER_DOMAIN, port: number = C_QLIK_SERVER_PORT): string => {
